<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAdd.aspx.cs" Inherits="TL.Web.SystemManage.Sys.UserAdd" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="panel">
    ...
    <div class="toolBar">
        <div class="currentMenu">添加管理员</div>
    ...
    <div class="content">
        ...
        <form action="?action=add" method="post" onsubmit="return checkAdd();">
            ...
            <div class="formBtn"><button type="submit">添 加</button><button type="reset">清 空</button></div>

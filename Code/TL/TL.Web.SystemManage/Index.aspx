<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="TL.Web.SystemManage.Index" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Frameset//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-frameset.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta http-equiv="Content-Language" content="zh-CN"/>
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title><%=S.SiteName %>管理中心</title>
    ...
    <frameset rows="*,30" framespacing="0" frameborder="no" border="0">
        <frameset cols="180,*" frameborder="no" border="0" framespacing="0">
            ...
            <frameset cols="6,*" framespacing="0" frameborder="no" border="0">
                ...
                <!--[if IE 6]>
                <frame src="sys/paramedit.aspx" id="mainFrame" name="mainFrame" scrolling="Yes" noresize="noresize" />
                <![endif]-->
                <!--[if gte IE 7]>
                <frame src="sys/paramedit.aspx" id="mainFrame" name="mainFrame" style="overflow:auto" noresize="noresize" />
                <![endif]-->
                <!--[if !IE]><!-->
                <frame src="sys/paramedit.aspx" id="mainFrame" name="mainFrame" style="overflow:auto" noresize="noresize" />
                <!--<![endif]-->
